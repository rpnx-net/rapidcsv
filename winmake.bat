...
msbuild /m /nologo /verbosity:quiet /property:Configuration=Debug rntcsv.sln || goto :error
...
msbuild /m /nologo /verbosity:quiet /property:Configuration=Release rntcsv.sln || goto :error
